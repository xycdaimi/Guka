...
class Phonetic_cloning(object):
    def __init__(self, model_path="model/so-vits-svc/keli50000.pth", spk_list=['keli'], device=None, trans=[0], config_path="model/so-vits-svc/config.json", clip=0):
        #wav文件名列表，放在raw文件夹下
    ...
    def forward(self, clean_names=["output.wav"], name='output'):
